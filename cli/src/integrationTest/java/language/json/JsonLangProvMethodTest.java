...
import com.example.json_lang_language_method.*;
 ...
 * {@link LanguageProvider#languageMethod()}.
 *
 * <p>Uses code generated for {@code node-types-json.json}.
 */
class JsonLangProvMethodTest extends AbstractTypedTreeTest {
    private JsonLangProvMethodTest() {
        super("json", ".json");
    }
