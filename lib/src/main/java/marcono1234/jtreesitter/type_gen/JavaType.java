...
sealed public interface JavaType permits JavaTypeImpl {
    /**
     * Obtains a {@code JavaType} from a Java reflection type, for example {@code String.class}.
     */
     ...
     *     <li>{@code void} is not allowed, instead the API consuming a {@code JavaType} expects an empty {@link Optional} to represent {@code void}
    ...
    //   However, currently it is an implementation detail that JavaPoet is used for code generation
    //   Could maybe expose this as 'experimental' method? Though alternatively users could use the string representation
}
