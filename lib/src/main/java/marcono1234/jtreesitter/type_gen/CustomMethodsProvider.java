 ...
 * node type. Ensure that there is no method signature conflict for the custom methods, or that the custom
 * methods (intentionally) override each other.<br>
...
public interface CustomMethodsProvider {
     ...
     *      optional additional arguments to pass to the {@code receiverMethod}<br>
     *      These can for example be used to tell apart the different call sites of the {@code receiverMethod},
    ...
    record MethodData(
        ...
        // TODO: Maybe here and everywhere else rename this to 'target'?
     ...
     *
     * <p>{@code TypedNode} is the base type for all typed node classes, it wraps the underlying jtreesitter {@code Node}.
     */
    ...
    // TODO Also for children token type? (currently unused)

    /**
     * Custom methods for the generated interface for the field types of the given node type and field.
     *
    ...
    // TODO Also for field token type?
}
