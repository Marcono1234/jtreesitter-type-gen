...
public final class NodeSupertypeChild implements TypedNode {
  ...
  private static Stream<NodeSupertypeChild> findNodesImpl(TypedNode startNode,
      SegmentAllocator allocator) {
    var startNodeUnwrapped = startNode.getNode();
    var language = startNodeUnwrapped.getTree().getLanguage();
    // tree-sitter query which matches the nodes of this type, and captures them
   ...
   * <h4>Example</h4>
   * {@snippet lang=java :
   * try (var nodes = NodeSupertypeChild.findNodes(start, allocator)) {
   *   List<String> texts = nodes.map(n -> n.getText()).toList();
   *   ...
   * }
   * }
  ...
  @Override
  public String toString() {
    return "NodeSupertypeChild" + "[id=" + Long.toUnsignedString(node.getId()) + "]";
  }
}
...
public final class NodeMultipleChildren implements TypedNode {
  ...
  private static Stream<NodeMultipleChildren> findNodesImpl(TypedNode startNode,
      SegmentAllocator allocator) {
    var startNodeUnwrapped = startNode.getNode();
    var language = startNodeUnwrapped.getTree().getLanguage();
    // tree-sitter query which matches the nodes of this type, and captures them
   ...
   * <h4>Example</h4>
   * {@snippet lang=java :
   * try (var nodes = NodeMultipleChildren.findNodes(start, allocator)) {
   *   List<String> texts = nodes.map(n -> n.getText()).toList();
   *   ...
   * }
   * }
  ...
  @Override
  public String toString() {
    return "NodeMultipleChildren" + "[id=" + Long.toUnsignedString(node.getId()) + "]";
  }
...
public final class NodeSelfChildren implements TypedNode, NodeSelfChildren$Child {
  ...
  private static Stream<NodeSelfChildren> findNodesImpl(TypedNode startNode,
      SegmentAllocator allocator) {
    var startNodeUnwrapped = startNode.getNode();
    var language = startNodeUnwrapped.getTree().getLanguage();
    // tree-sitter query which matches the nodes of this type, and captures them
   ...
   * <h4>Example</h4>
   * {@snippet lang=java :
   * try (var nodes = NodeSelfChildren.findNodes(start, allocator)) {
   *   List<String> texts = nodes.map(n -> n.getText()).toList();
   *   ...
   * }
   * }
  ...
  @Override
  public String toString() {
    return "NodeSelfChildren" + "[id=" + Long.toUnsignedString(node.getId()) + "]";
  }
}
...
public final class NodeSelfIndirectChildren implements TypedNode, NodeSupertypeIndirect {
  ...
  private static Stream<NodeSelfIndirectChildren> findNodesImpl(TypedNode startNode,
      SegmentAllocator allocator) {
    var startNodeUnwrapped = startNode.getNode();
    var language = startNodeUnwrapped.getTree().getLanguage();
    // tree-sitter query which matches the nodes of this type, and captures them
   ...
   * <h4>Example</h4>
   * {@snippet lang=java :
   * try (var nodes = NodeSelfIndirectChildren.findNodes(start, allocator)) {
   *   List<String> texts = nodes.map(n -> n.getText()).toList();
   *   ...
   * }
   * }
  ...
  @Override
  public String toString() {
    return "NodeSelfIndirectChildren" + "[id=" + Long.toUnsignedString(node.getId()) + "]";
  }
}
...
public final class NodeSelfTransitiveIndirectChildren implements TypedNode, NodeSupertypeTransitiveIndirect1 {
  ...
  private static Stream<NodeSelfTransitiveIndirectChildren> findNodesImpl(TypedNode startNode,
      SegmentAllocator allocator) {
    var startNodeUnwrapped = startNode.getNode();
    var language = startNodeUnwrapped.getTree().getLanguage();
    // tree-sitter query which matches the nodes of this type, and captures them
   ...
   * <h4>Example</h4>
   * {@snippet lang=java :
   * try (var nodes = NodeSelfTransitiveIndirectChildren.findNodes(start, allocator)) {
   *   List<String> texts = nodes.map(n -> n.getText()).toList();
   *   ...
   * }
   * }
  ...
  @Override
  public String toString() {
    return "NodeSelfTransitiveIndirectChildren" + "[id=" + Long.toUnsignedString(node.getId()) + "]";
  }
}
...
public final class NodeChildOfEachOtherA implements TypedNode, NodeChildOfEachOtherB$Child {
  ...
  private static Stream<NodeChildOfEachOtherA> findNodesImpl(TypedNode startNode,
      SegmentAllocator allocator) {
    var startNodeUnwrapped = startNode.getNode();
    var language = startNodeUnwrapped.getTree().getLanguage();
    // tree-sitter query which matches the nodes of this type, and captures them
   ...
   * <h4>Example</h4>
   * {@snippet lang=java :
   * try (var nodes = NodeChildOfEachOtherA.findNodes(start, allocator)) {
   *   List<String> texts = nodes.map(n -> n.getText()).toList();
   *   ...
   * }
   * }
  ...
  @Override
  public String toString() {
    return "NodeChildOfEachOtherA" + "[id=" + Long.toUnsignedString(node.getId()) + "]";
  }
}
...
public final class NodeChildOfEachOtherB implements TypedNode, NodeChildOfEachOtherA$Child {
  ...
  private static Stream<NodeChildOfEachOtherB> findNodesImpl(TypedNode startNode,
      SegmentAllocator allocator) {
    var startNodeUnwrapped = startNode.getNode();
    var language = startNodeUnwrapped.getTree().getLanguage();
    // tree-sitter query which matches the nodes of this type, and captures them
   ...
   * <h4>Example</h4>
   * {@snippet lang=java :
   * try (var nodes = NodeChildOfEachOtherB.findNodes(start, allocator)) {
   *   List<String> texts = nodes.map(n -> n.getText()).toList();
   *   ...
   * }
   * }
  ...
  @Override
  public String toString() {
    return "NodeChildOfEachOtherB" + "[id=" + Long.toUnsignedString(node.getId()) + "]";
  }
}
...
public sealed interface NodeSupertypeIndirect extends TypedNode, NodeSelfIndirectChildren$Child permits NodeContainedA, NodeSelfIndirectChildren {
  ...
  private static Stream<NodeSupertypeIndirect> findNodesImpl(TypedNode startNode,
      SegmentAllocator allocator) {
    var startNodeUnwrapped = startNode.getNode();
    var language = startNodeUnwrapped.getTree().getLanguage();
    // tree-sitter query which matches the nodes of this type, and captures them
   ...
   * <h4>Example</h4>
   * {@snippet lang=java :
   * try (var nodes = NodeSupertypeIndirect.findNodes(start, allocator)) {
   *   List<String> texts = nodes.map(n -> n.getText()).toList();
   *   ...
   * }
   * }
...
public sealed interface NodeSupertypeTransitiveIndirect1 extends TypedNode, NodeSupertypeTransitiveIndirect2 permits NodeContainedA, NodeSelfTransitiveIndirectChildren {
  ...
  private static Stream<NodeSupertypeTransitiveIndirect1> findNodesImpl(TypedNode startNode,
      SegmentAllocator allocator) {
    var startNodeUnwrapped = startNode.getNode();
    var language = startNodeUnwrapped.getTree().getLanguage();
    // tree-sitter query which matches the nodes of this type, and captures them
   ...
   * <h4>Example</h4>
   * {@snippet lang=java :
   * try (var nodes = NodeSupertypeTransitiveIndirect1.findNodes(start, allocator)) {
   *   List<String> texts = nodes.map(n -> n.getText()).toList();
   *   ...
   * }
   * }
...
public sealed interface NodeSupertypeTransitiveIndirect2 extends TypedNode, NodeSelfTransitiveIndirectChildren$Child permits NodeContainedA, NodeSupertypeTransitiveIndirect1 {
  ...
  private static Stream<NodeSupertypeTransitiveIndirect2> findNodesImpl(TypedNode startNode,
      SegmentAllocator allocator) {
    var startNodeUnwrapped = startNode.getNode();
    var language = startNodeUnwrapped.getTree().getLanguage();
    // tree-sitter query which matches the nodes of this type, and captures them
   ...
   * <h4>Example</h4>
   * {@snippet lang=java :
   * try (var nodes = NodeSupertypeTransitiveIndirect2.findNodes(start, allocator)) {
   *   List<String> texts = nodes.map(n -> n.getText()).toList();
   *   ...
   * }
   * }
